 ...
 *    2012-08-20 @Akkiesoft modify callbackUrl.
 *  Copyright (c) 2010, 2011 Rob Griffiths (http://bytespider.eu)
 *  Copyright (c) 2012 Akkiesoft (@Akkiesoft)
        ...
        init: function (options) {
            ...
            this.request = function (options) {
                var method, url, data, headers, success, failure, xhr, i,
                    ...
                    query = [], appendQueryString, signatureData = {}, params, withFile, callbackUrl;
